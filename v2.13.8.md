...
Rancher v2.13.8 is the latest patch release of Rancher. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
## What’s New - SUSE Rancher Prime v2.13.8
...
- Fixed a security vulnerability where long-lived Rancher registration tokens were stored or exposed in plaintext, allowing an attacker who obtained a token to register a rogue node and potentially take over a downstream cluster. `ClusterRegistrationToken` credentials are now stored in Kubernetes Secrets with a TTL token rotation and expiration feature (opt-in in Rancher 2.13, enabled by default in Rancher 2.15 and later). The v2prov install script’s file permissions are hardened to owner-readable only for provisioning new machines. For more information, refer to [CVE-2026-55997](https://github.com/rancher/rancher/security/advisories/GHSA-7r53-jvhg-9jq4).

## Changes Since v2.13.7

See the full list of [changes](https://github.com/rancher/rancher/compare/v2.13.7%E2%80%A6v2.13.8).
...
- rancher/rancher:v2.13.8

### Tools

- CLI - [v2.13.8](https://github.com/rancher/cli/releases/tag/v2.13.8)
