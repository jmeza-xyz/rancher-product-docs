...
ifeval::["{build-type}" != "community"]
If you're installing Rancher for the first time, your environment must fulfill the xref:installation-and-upgrade/requirements/requirements.adoc[installation requirements].
endif::[]
